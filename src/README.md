...
picotool info -a soundboard.uf2 or .elf will list the UART and SDCARD and I2C pins for each build. I2S audio pins are default pins in the pico-extras i2s audio library for both builds.
